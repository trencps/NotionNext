...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TRNote', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'TRkamui', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nt.665669.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'TR', // 网站关键词 英文逗号隔开
